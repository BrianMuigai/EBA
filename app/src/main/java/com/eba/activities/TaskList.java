...
import com.eba.adapters.AlarmListAdapter;
import com.eba.R;
...
public class TaskList extends BaseActivity {
    ...
    public static final int HEALTH = 111;
    public static final int OTHER = 333;
    ...
    public static void start(MainActivity mainActivity, int type) {
        Intent intent = new Intent(mainActivity, TaskList.class);
    ...
    public void onCreate(Bundle bundle) {
        ...
        type = getIntent().getIntExtra(ARG_TYPE, TaskList.OTHER);

        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               onAddAlarmClick(view);
            }
        });

        Log.i(TAG, "TaskList.onCreate()");

        mAlarmList = (ListView) findViewById(R.id.object_list);

        mAlarmListAdapter = new AlarmListAdapter(this, type);
...
//    mAlarmListAdapter.save();
    ...
    public void onAddAlarmClick(View view) {
        ...
        mCurrentAlarm.setType(type);
        mCurrentAlarm.toIntent(intent);

        TaskList.this.startActivityForResult(intent, NEW_ALARM_ACTIVITY);
    }
    ...
    private AdapterView.OnItemClickListener mListOnItemClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            mCurrentAlarm.toIntent(intent);
            TaskList.this.startActivityForResult(intent, EDIT_ALARM_ACTIVITY);
        }
    };
